...
## Notamos que la interpretación varia en funcion de qué frecuencia usemos.
...
Usamos product(y,x). Permite generar una **lista de vectores** dentro de nuestra *x*, ya que geom_mosaic no posee un *Y*.
